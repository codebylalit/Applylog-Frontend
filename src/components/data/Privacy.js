        ...
        <Paper elevation={3} className="p-10 mt-8">
          ...
          <Box className="space-y-6">
            ...
            <Typography variant="body1">
              ...
              used primarily to provide and improve ApplyLog's services,
              including managing and organizing your job applications, analyzing
              usage trends to enhance our service, and communicating with you
              about updates, new features, or important notices related to
              ApplyLog.
            </Typography>
            <Typography variant="body1">
            ...
            <Typography variant="body1">
              ...
              or when necessary to provide our services. Your data remains
              confidential and is used solely for the purposes outlined in this
              Privacy Policy.
            </Typography>
            <Typography variant="body1">
              <strong>Your Choices:</strong> You have the right to access,
              correct, or delete your personal information stored in ApplyLog.
              You can manage your account settings and preferences within the
              application.
            </Typography>
            <Typography variant="body1">
